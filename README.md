...
- Спринт 1: https://github.com/K1rikaru/devops
- Спринт 2: https://gitlab.com/pavelcherepanov94/sf_diplom
- Спринт 3: https://gitlab.com/pavelcherepanov94/monitoring
...
2. Скачать репо и перейти в директорию `git clone https://github.com/k1rikaru/sf-diploma-sprint1.git && cd sf-diploma-sprint1/terraform`
...
В итоге имеем:
- **Grafana** доступна по публичному адресу сервера **srv** на порту 3000 - http://89.169.153.110:3000/ . Логин и пароль **admin** и **admin**.
- **Prometheus** на том же адресе, на порту 9090 - http://89.169.153.110:9090/
...
1. Заходим в интерфейс **Grafana** http://89.169.153.110:3000/ . Логин и пароль **admin** и **admin**.
